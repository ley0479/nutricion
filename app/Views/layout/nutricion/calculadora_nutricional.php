<div class="content-wrapper">
    ...
    <div class="contenedor">
        <p>La Calculadora Nutricional ofrece a los usuarios la capacidad de calcular
                    ...
                    <form id="form-buscar-recetas" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ingrediente" name="ingrediente"
                                placeholder="Ej: pollo, arroz, carne de res, pescado etc.">
                        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.recetas.length > 0) {
                    ...
                    $('#mensaje-error').show();
                    $('#error-texto').text(
                        'No se encontraron recetas para el ingrediente ingresado.');
                }
            },
            error: function() {
                $('#loader').hide();
