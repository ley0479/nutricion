<div class="content-wrapper">
    ...
    <br>
    <hr>
    <p style="text-align: justify;">La sección de Recomendaciones Nutricionales Según Tus Objetivos 
        ...
        salud y bienestar de manera efectiva y sostenible.</p>
        <hr>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <ul>
                        ...
                        <li><strong>Carbohidratos Diarios:</strong> <?= esc($objetivos['carbohidratos_diarios']) ?> g</li>
        ...
        success: function(response) {
            ...
            if (recetas.length > 0) {
                ...
                recetas.forEach(function(receta) {
                    ...
                    resultadosHtml += '<img src="' + receta.image + '" class="card-img-top" alt="' + receta.label + '">';
                    resultadosHtml += '<div class="card-body">';
                    resultadosHtml += '<h5 class="card-title">' + receta.label + '</h5>';
                    resultadosHtml += '<p class="card-text">Calorías: ' + Math.round(receta.nutrition.calories) + '</p>';
                    ...
                    resultadosHtml += '<a href="' + receta.url + '" class="btn btn-primary" target="_blank">Ver Receta</a>';
